...
local SilentAimSettings = {
    ...
    ClassName = "SHub Universal Silent Aim",
    ToggleKey = "MB2",
...
mouse_box.Color = Color3.fromRGB(255, 17, 0)
...
fov_circle.Color = Color3.fromRGB(255, 17, 0)
...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/SHubScripts/ShubSilent/main/Library.lua"))()
Library:SetWatermark("SHub (Insert)")

local Window = Library:CreateWindow("SHub Universal Silent Aim")
local GeneralTab = Window:AddTab("General")
local MainBOX = GeneralTab:AddLeftTabbox("Main") do
    local Main = MainBOX:AddTab("Main")
    
    Main:AddToggle("aim_Enabled", {Text = "Enabled"}):AddKeyPicker("aim_Enabled_KeyPicker", {Default = "MB2", SyncToggleState = true, Mode = "Toggle", Text = "Enabled", NoUI = false});
    ...
    Main:AddDropdown("TargetPart", {AllowNull = true, Text = "Target Part", Default = SilentAimSettings.TargetPart, Values = {"Head", "Body", "Random"}}):OnChanged(function()
...
local FieldOfViewBOX = GeneralTab:AddLeftTabbox("Field Of View") do
    ...
    Main:AddToggle("Visible", {Text = "Show FOV"}):AddColorPicker("Color", {Default = Color3.fromRGB(255, 255, 255)}):OnChanged(function()
        fov_circle.Visible = Toggles.Visible.Value
        SilentAimSettings.FOVVisible = Toggles.Visible.Value
    end)
    Main:AddSlider("Radius", {Text = "FOV Size", Min = 0, Max = 800, Default = 130, Rounding = 0}):OnChanged(function()
        fov_circle.Radius = Options.Radius.Value
        SilentAimSettings.FOVRadius = Options.Radius.Value
    end)
    Main:AddToggle("MousePosition", {Text = "Show Target"}):AddColorPicker("MouseVisualizeColor", {Default = Color3.fromRGB(255, 0, 0)}):OnChanged(function()
